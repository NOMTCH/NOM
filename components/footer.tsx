...
export const Footer = () => {
  ...
  return (
    <footer className="bg-background/90 dark:bg-background/40 backdrop-blur-sm relative overflow-hidden py-12">
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-[#00F0FF]/5 pointer-events-none\" />
      <motion.div
